...
class CircleIconBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ic = color ?? (isDark ? BubblesColors.textSecondaryDark : BubblesColors.textSecondaryLight);
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: filled ? BubblesColors.primary : (isDark ? BubblesColors.glassDark : BubblesColors.glassLight),
          border: Border.all(
