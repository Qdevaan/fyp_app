...
void main() {
  ...
  // Make sure glass_morphism is imported
  if (!content.contains("import '../widgets/glass_morphism.dart';")) {
  ...
  if (content.contains(inputWrapperCloseOld)) {
    // Only replace the FIRST occurrence in the file by splitting (it appears exactly once at the end)
